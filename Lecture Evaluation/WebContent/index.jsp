...
<body>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터개론&nbsp;<small>이주형</small></div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						...
						여유로움<span style="color: red;">A</span>
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터그래픽스&nbsp;<small>주형</small></div>
					<div class="col-4 text-right">
						종합<span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span>
						여유로움<span style="color: red;">D</span>
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터구조&nbsp;<small>이주</small></div>
					<div class="col-4 text-right">
						종합<span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						...
						여유로움<span style="color: red;">B</span>
						강의<span style="color: red;">F</span>
	...
	<footer class="bg-dark mt-2 p-3 text-center" style="color: #FFFFFF;">
		Copyright %copy; 2020 이주형 All Rights Reserved.
	</footer>	
	<!--  제이쿼리 자바스크립트 추가하기 -->
