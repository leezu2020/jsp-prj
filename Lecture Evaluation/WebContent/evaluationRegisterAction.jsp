...
<%
	...
	if (lectureName == null || professorName == null || lectureYear == 0 || semesterDivide == null
			|| evaluationTitle.equals("") || evaluationContent.equals("") || totalScore == null
			|| gradeScore == null || comfortableScore == null || lectureScore == null
			|| evaluationTitle == null || evaluationContent == null || lectureDivide == null){
		PrintWriter script = response.getWriter();
		script.println("<script>");
	...
	int result = evaluationDAO.write(new EvaluationDTO(0, userID, lectureName, professorName,
			...
			totalScore, gradeScore, comfortableScore, lectureScore, 0));
	if (result == -1) {
		PrintWriter script = response.getWriter(); 
		script.println("<script>");
